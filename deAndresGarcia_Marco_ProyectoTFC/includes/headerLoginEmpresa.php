    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="relative flex items-center">
            ...
            <?php if (isset($_SESSION["id_usuario"])): ?>
                ...
                <?php endif; ?>
                <!-- carrito visible solo por los usuarios-->
                <a href="carrito.php"
            ...
            <?php else: ?>
                <a href="login_empresa.php" class="mx-3 hover:text-blue-400">Iniciar Sesión</a>
                <a href="registro_empresa.php" class="mx-3 hover:text-blue-400">Registro</a>
            <?php endif; ?>
        </div>
    </div>
</nav>
