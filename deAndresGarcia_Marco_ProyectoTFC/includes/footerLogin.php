<footer class="bg-gray-900 text-white py-6">
    <div class="container max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start text-center md:text-left px-6 space-y-6 md:space-y-0 md:space-x-16">
        ...
        <div class="w-full md:w-1/3 flex flex-col items-center">
            ...
            <ul class="space-y-1">
                <li><a href="login.php" class="text-gray-400 hover:text-blue-400">Iniciar Sesión</a></li>
                <li><a href="registro.php" class="text-gray-400 hover:text-blue-400">Registro</a></li>
                <li><a href="contacto.php" class="text-gray-400 hover:text-blue-400">Contacto</a></li>
                <a href="legal.php" class="hover:underline">Aviso legal</a>
            </ul>
        </div>
        ...
        <div class="w-full md:w-1/3 flex flex-col items-center md:items-end">
            ...
            <p class="text-gray-400 text-sm flex items-center">
                📧 <span class="ml-2">contacto.evenly@gmail.com</span>
            </p>
            <p class="text-gray-400 text-sm flex items-center">
                📞 <span class="ml-2">+34 644 75 80 06</span>
            </p>
        </div>
    </div>
